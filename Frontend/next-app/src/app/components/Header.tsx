...
const EventFeedPage = () => {
  ...
  return (
    <header className="flex items-center border-b-2 border-b-gray-400 p-3 mx-5 space-x-15 font-sans font-bold">
      <Link href="/" className="text-2xl grow-1">
        YUEvents
      </Link>
      <nav className="flex overflow-hidden space-x-15 text-xl">
        <HeaderEvents />
