...
const handleSignIn = async () => {
  ...
  try{
   ...
   <div className="flex-1 flex flex-col  text-blue-200 ml-40 gap-5">
       ...
       className="text-6xl font-bold">Welcome Back!</motion.h1>
       <motion.p 
       ref={textRef}
       animate={show ? "visible" : "hidden"}
       variants={textVariant} 
       custom={1}
       className="w-xl mt-3"> Access all your campus events and stay updated with the latest news from your school. 
    From workshops, guest lectures, to social gatherings, our platform ensures you never miss 
    an opportunity to get involved. Please log in to continue </motion.p>
     <motion.div 
     ref={textRef}
       animate={show ? "visible" : "hidden"}
       variants={textVariant} 
   ...
   className="flex-1 flex justify-center items-center h-screen mr-40">
      <form className=" p-6 rounded shadow-md h-100 w-100 text-blue-200 ">
        <h2 className="text-5xl font-extralight mb-5 flex justify-center mt-8 ">Sign In</h2>
        <p>Email Address</p>
        <input 
        type="email" 
        placeholder="Email" 
        ...
        <button type="submit" className="flex mt-5 mb-5 font-mono bg-blue-600 text-white px-4 py-2 rounded cursor-pointer transform transition-transform  duration-500 hover:scale-110">Log In</button>
